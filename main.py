...
# ============================================================================
# PAGE ROUTES - SEO OPTIMIZED (FORCED SEPARATION)
# ============================================================================

@app.get("/", response_class=HTMLResponse)
async def root_redirect():
    # Force redirect to Arabic version for better structure
    return RedirectResponse("/ar/")
...
async def auth_redirect(): return RedirectResponse("/ar/auth")
...
async def pricing_redirect(): return RedirectResponse("/ar/pricing")
...
async def tools_redirect(): return RedirectResponse("/ar/tools")
...
async def code_hub_redirect(): return RedirectResponse("/ar/code-hub")
...
async def ent_redirect(): return RedirectResponse("/ar/enterprise")
...
async def docs_redirect(): return RedirectResponse("/ar/docs")
...
async def policy_redirect(): return RedirectResponse("/ar/policy")
...
async def dash_redirect(): return RedirectResponse("/ar/dashboard")
